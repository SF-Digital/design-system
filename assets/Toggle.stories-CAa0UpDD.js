import{j as n}from"./jsx-runtime-Nms4Y4qS.js";import{c as t}from"./index-CccjctYd.js";/* empty css               */import"./index-BwDkhjyp.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-B8XB3FuZ.js";const p={title:"Components/Toggle",component:t.Root,args:{size:"md",color:"sf-green"},argTypes:{size:{options:["sm","md"],control:{type:"inline-radio"}},color:{options:["sf-green","succession-blue"],control:{type:"inline-radio"}}},parameters:{docs:{description:{component:`This story displays the \`Toggle\` component, which is a React element built using Pattern Composition. Types generated for each component are exported as \`Toggle{ComponentName}Props\`.
