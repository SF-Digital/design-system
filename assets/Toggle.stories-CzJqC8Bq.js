import{j as n}from"./index-ixxFTlCi.js";import{c as t}from"./index-CtIfSIPN.js";import"./output-C6jOtb2S.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DSHYqwJA.js";import"./index-DqtkcwbH.js";const p={title:"Components/Toggle",component:t.Root,args:{size:"md",color:"sf-green"},argTypes:{size:{options:["sm","md"],control:{type:"inline-radio"}},color:{options:["sf-green","succession-blue"],control:{type:"inline-radio"}}},parameters:{docs:{description:{component:`This story displays the \`Toggle\` component, which is a React element built using Pattern Composition. Types generated for each component are exported as \`Toggle{ComponentName}Props\`.
