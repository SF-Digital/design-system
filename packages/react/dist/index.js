...
var button = (0, import_tailwind_variants3.tv)(
  {
    ...
    compoundVariants: [
      ...
      },
      {
        color: "sf-green",
        variant: "primary",
        className: "bg-primary-green-500 hover:bg-primary-green-700 active:bg-primary-green-500 active:ring-4 active:ring-primary-green-50 disabled:border disabled:border-neutral-50 disabled:bg-neutral-20 disabled:text-neutral-80"
      },
      {
        color: "success",
        variant: "primary",
