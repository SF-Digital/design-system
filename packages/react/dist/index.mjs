    ...
    compoundVariants: [
      {
        color: "sf-green",
        variant: "primary",
        className: "bg-primary-green-500 hover:bg-primary-green-700 active:bg-primary-green-800 disabled:border disabled:border-neutral-50 disabled:bg-neutral-20 disabled:text-neutral-80"
      },
      {
        color: "neutral",
        variant: "secondary",
