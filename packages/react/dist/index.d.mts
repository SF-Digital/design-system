...
declare const Box: ({
	className,
	...rest
}: BoxProps) => react_jsx_runtime.JSX.Element
...
declare const TextInput: {
	Root: ({
		...
		color,
		...props
	}: TextInputRootProps) => react_jsx_runtime.JSX.Element
	Control: {
...
declare const checkbox: tailwind_variants.TVReturnType<
	...
	>
>
type CheckboxRootProps = ComponentProps<typeof Checkbox$1.Root> &
	VariantProps<typeof checkbox>

type CheckboxIndicatorProps = ComponentProps<
	typeof Checkbox$1.CheckboxIndicator
>
...
declare const radio$1: tailwind_variants.TVReturnType<
	{} | {} | {},
	undefined,
	...
	>
>
type RadioGroupRootProps = ComponentProps<typeof RadioGroup$1.Root> &
	VariantProps<typeof radio$1>
...
declare const RadioGroup: {
	Root: ({
		className,
		...props
	}: RadioGroupRootProps) => react_jsx_runtime.JSX.Element
	Item: ({
		className,
		size,
		color,
		...props
	}: RadioGroupItemProps) => react_jsx_runtime.JSX.Element
}
...
declare const Tabs: {
	Root: ({
		hasBackground,
		...props
	}: TabsRootProps) => react_jsx_runtime.JSX.Element
...
declare const Toggle: {
	Root: ({
		...
		size,
		...props
	}: ToggleRootProps) => react_jsx_runtime.JSX.Element
	Control: ({
		className,
		size,
		...props
	}: ToggleControlProps) => react_jsx_runtime.JSX.Element
}
...
declare const Avatar: {
	Root: ({
		...
		size,
		...props
	}: AvatarRootProps) => react_jsx_runtime.JSX.Element
...
declare const content: tailwind_variants.TVReturnType<
	...
	>
>
type TooltipContentProps = Tooltip$1.TooltipContentProps &
...
declare const Tooltip: {
	...
	Content: ({
		...
		className,
		...props
	}: TooltipContentProps) => react_jsx_runtime.JSX.Element
	Arrow: ({
		...props
	}: Tooltip$1.TooltipArrowProps) => react_jsx_runtime.JSX.Element
}
...
declare const Select: {
	...
	Trigger: ({
		color,
		...props
	}: SelectTriggerProps) => react_jsx_runtime.JSX.Element
...
declare const TextArea: {
	Root: ({
		...
		className,
		...props
	}: TextAreaRootProps) => react_jsx_runtime.JSX.Element
